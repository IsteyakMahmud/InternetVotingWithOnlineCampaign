...
<div class="container py-5 mt-5 justify-content-center">
    <div class="card py-5 mt-5 mx-auto" style="width: 40rem;">
        <div class="mx-auto form">
            <form class="form-login" action="otp-verify.php" method="POST">
                <h3 class="text-center">OTP Verification</h3>
                <span class="text-center">Enter the code we just send on your email</span>
                ...
                <div class="form-group py-3">
                    ...
                    <button type="submit" class="btn btn-danger" name="resend">Resend OTP</button>
                </div>
            </form>
        </div>
    </div>
