...
<!--                    </div>-->
                    ...
                    <div class="form-group">
                        <label for="position" class="col-sm-3 control-label">Election</label>
                        <div class="col-sm-9">
...
<!--                    </div>-->
                    ...
                    <div class="form-group">
                        <label for="edit_position" class="col-sm-3 control-label">Election</label>
                        <div class="col-sm-9">
                            <select class="form-control" id="edit_election" name="election_id" required>
                                <option value="" selected id="edit_election_id">-- Select --</option>
                                <?php
                                $sql = "SELECT * FROM elections";
                                $query = $conn->query($sql);
                                while ($row = $query->fetch_assoc()) {
...
<div class="modal fade" id="reset">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="text-center">
                    <p>RESET ALL VOTERS</p>
                    <h4>This will delete all voters and counting back to 0.</h4>
                </div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default btn-flat pull-left" data-dismiss="modal"><i
