<aside class="main-sidebar">
  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li class=""><a href="votes.php"><i class="fa fa-server"></i> <span>Ballots</span></a></li>
      <li class=""><a href="ballots.php"><i class="fa fa-lock"></i> <span>Votes</span></a></li>
      <li class="header">MANAGE</li>
      <li class=""><a href="elections.php"><i class="glyphicon glyphicon-list-alt"></i> <span>Elections</span></a></li>
      <li class=""><a href="voters.php"><i class="fa fa-users"></i> <span>Voters</span></a></li>
      <li class=""><a href="positions.php"><i class="glyphicon glyphicon-list"></i> <span>Positions</span></a></li>
