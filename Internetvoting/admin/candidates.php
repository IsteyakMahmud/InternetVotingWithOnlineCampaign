                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header with-border">
                            ...
                            <a href="#" data-toggle="modal" class="btn btn-danger btn-sm btn-flat"><i class="fa fa-refresh"></i> Reset</a>
                            <p>Select Election</p>
                            <div class="btn-group">
                                <button type="button" class="btn btn-default">All Candidates</button>
    ...
    function getRow(id) {
        $.ajax({
            ...
            success: function (response) {
                ...
                // $('#edit_election').val(response.election_id).html(response.description);
